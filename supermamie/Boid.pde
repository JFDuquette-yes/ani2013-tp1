class Boid
{
  ...
  void render()
  {
    //ill(random(90,256),random(9,256),random(0,256),255);
   ...
   // blendMode(MULTIPLY);
    ...
    pushMatrix();translate(position.x, position.y);
    rect(0.0f, radius * 2.0f, radius * 2.0f, radius * 2.0f);
